...
export const info = {
    ...
    position: "Fresh Graduate from State Polytechnic of Malang",
    ...
    miniBio: [ // these are just some "tidbits" about yourself. You can look at mine https://paytonjewell.github.io/#/ for an example if you'd like
        ...
        {
            emoji: '🌎',
            text: 'Based in the Blitar, East Java'
        },
        {
            emoji: "💼",
            text: "Desired to be System Analyst and UI/UX Designer"
        },
        {
            emoji: "📧",
    ...
    socials: [
        ...
        {
            link: "https://linkedin.com/viviagustinas",
            icon: "fa fa-linkedin",
            label: 'linkedin'
        },
        {
        ...
        {
            link: "https://drive.google.com/file/d/14CK7zBlzxFPjUYrBmkYGPHTIuqlJDTzI/view?usp=sharing",
            icon: "fa fa-file",
            label: 'cv'
        }
...
// Just change the links so that they lead to your social profiles.
    ...
    bio: "Hello! I'm Vivi. An Informatics Engineering Bachelor's Degree of from State Polytechnic Of Malang (Agustus 2018 - July 2022) who currently learning System Analyst and UI/UX Designer. Had experience as Strategy Architechture and Design IT at the pawnshop Indonesia. Skilled in good communication, teamwork, analytical thinking and problem solving.",
    skills:
        {
            proficientWith: ['Figma', 'Adobe XD', 'Justinmind', 'Visual Paradigm', 'bootstrap', 'html5', 'My SQL', 'css3']
        }
    ,
    hobbies: [
        {
    ...
    portfolio: [ // This is where your portfolio projects will be detailed
        {
            ...
            source: "https://www.figma.com/proto/8gTP5wm7ffYhFPENyYPZ4m/Kelompok-4?page-id=164%3A282&node-id=164%3A283&viewport=342%2C297%2C0.13&scaling=scale-down&starting-point-node-id=164%3A283", // this should be a link to the **repository** of the project, where the code is hosted.
            image: mock1
        },
        {
            ...
            source: "https://www.figma.com/proto/1CvK2lxB7jidAhrSd4DMja/%F0%9F%8E%89Vivi-Agustina-Ratnasari---Assignment-Week-%237?page-id=336%3A76&node-id=498%3A467&viewport=443%2C64%2C0.07&scaling=scale-down&starting-point-node-id=475%3A491&show-proto-sidebar=1",
            image: mock2
        },
        {
            title: "Fonterra Application",
            desc: "This application is an online purchase application of various types and cheese products",
            source: "https://www.figma.com/proto/1CvK2lxB7jidAhrSd4DMja/%F0%9F%8E%89Vivi-Agustina-Ratnasari---Assignment-Week-%237?page-id=1210%3A2089&node-id=1216%3A2097&viewport=524%2C80%2C0.51&scaling=scale-downaytonjewell",
            image: mock3
        },
        {
            ...
            source: "https://www.figma.com/proto/1CvK2lxB7jidAhrSd4DMja/%F0%9F%8E%89Vivi-Agustina-Ratnasari---Assignment-Week-%237?page-id=1142%3A1600&node-id=1150%3A2438&viewport=-346%2C283%2C0.4&scaling=scale-down&starting-point-node-id=1143%3A1601&show-proto-sidebar=1",
            image: mock4
        },
        {
            title: "Monitoring And Management Information System For New Renewable Energy Based On Web GIS With RESTFUL API",
